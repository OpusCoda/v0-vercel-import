      ...
      <div className="mb-8 space-y-4">
        ...
        <div className="relative">
          ...
          <input
            ...
            className="w-full rounded-lg border border-[#2a2a35] bg-[#101017] pl-10 pr-4 py-2 font-sans text-sm text-[#e8e6e3] placeholder-[#7c7a76] focus:border-[#B87333] focus:outline-none focus:ring-1 focus:ring-[#B87333]/30"
          />
        </div>
        {/* Category Filter */}
          ...
          {CATEGORIES.map((cat) => (
            <button
              ...
              className={`rounded-full px-3 py-1 font-sans text-xs font-semibold transition-colors ${selectedCategories.has(cat)
                ...
                : "border border-[#2a2a35] bg-[#101017] text-[#b8b6b1] hover:border-[#B87333]/50"
                }`}
            >
              {cat}
            </button>
            ...
            <div className="flex items-start justify-between gap-4">
              <div>
                <div className="flex items-center gap-1.5">
                  <h3 className="font-serif text-lg font-semibold text-[#B87333]">Probability Shop</h3>
                  <a
                  ...
                  >
                    <QuestionMarkIcon className="h-3.5 w-3.5 text-[#7c7a76] hover:text-[#B87333] transition-colors" />
        ...
        {showP2P && (
          <div className="flex flex-col gap-4">
            <div className="flex items-start justify-between gap-4">
              <div>
                <div className="flex items-center gap-1.5">
                  <h3 className="font-serif text-lg font-semibold text-[#B87333]">Outcome Exchange</h3>
                  <a
