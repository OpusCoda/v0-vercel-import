  ...
  },
  {
    ...
    features: [
      ...
      },
      {
        ...
        body: "Holding and staking Smaug gives a fee discount on all trades, shared with P2P Market via SmaugStaking.",
      },
    ],
  },
]
  ...
  return (
    <section className="mx-auto max-w-7xl px-4 py-16 md:px-6 md:py-20">
      ...
      <p className="mx-auto mt-4 max-w-2xl text-pretty text-center font-sans text-base leading-relaxed text-[#b8b6b1]">
        P2P Market and the Probability Shop are related but mechanically very different products. Both launch with
