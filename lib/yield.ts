...
export const VAULTS = {
  ...
  OPUS_WBTC: {
    key: "OPUS_WBTC" as const,
    principal: "OPUS" as const,
    vault: "0x7daBB6Fd166710B4Bc9733E32C1CAca7F9CC992f" as Address,
    token: "0x9B5a65E37f338ADD1263530DDac8CEc56204bB3a" as Address,
    tokenSymbol: "OPUS",
    rewardSymbol: "PLS",
    rewardToken: null,
    ...
    defaultCompoundPct: 50,
    minCompoundPct: 0,
    deployBlock: 27617973n,
  },
  OPUS_WETH: {
    key: "OPUS_WETH" as const,
    principal: "OPUS" as const,
    vault: "0x00b30bb3a8a0d724687F9CF2e397909B716833da" as Address,
    token: "0x9B5a65E37f338ADD1263530DDac8CEc56204bB3a" as Address,
    tokenSymbol: "OPUS",
    rewardSymbol: "PLS",
    rewardToken: null,
  ...
  CODA_FUPA: {
    key: "CODA_FUPA" as const,
    principal: "CODA" as const,
    vault: "0x63e51cf462a1ee38EA8feBE9DE4389641Fb9c6Cb" as Address,
    token: "0x9F8d74dF6DD3145e858578B0bE1d9B11f41E0A28" as Address,
    tokenSymbol: "CODA",
    rewardSymbol: "PLSX",
    rewardToken: "0x95B303987A60C71504D99Aa1b13B4DA07b0790ab" as Address,
  ...
  CODA_SYDE: {
    key: "CODA_SYDE" as const,
    principal: "CODA" as const,
    vault: "0x17DB8ca7b50393739183C5573E31633Eb19D275f" as Address,
    token: "0x9F8d74dF6DD3145e858578B0bE1d9B11f41E0A28" as Address, // deposit token is CODA
    tokenSymbol: "CODA",
    rewardSymbol: "PLSX",
    rewardToken: "0x95B303987A60C71504D99Aa1b13B4DA07b0790ab" as Address,
...
export const VAULT_ABI = [
  ...
  { type: "function", name: "targetBalance", stateMutability: "view", inputs: [], outputs: [{ type: "uint256" }] },
  { type: "function", name: "totalReservedTarget", stateMutability: "view", inputs: [], outputs: [{ type: "uint256" }] },
