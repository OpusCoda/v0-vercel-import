...
},
{
  ...
  },
  {
    ...
    inputs: [
      ...
      { type: "bool", name: "side", indexed: false },
      { type: "uint256", name: "plsIn", indexed: false },
      { type: "uint256", name: "sharesOut", indexed: false },
      { type: "uint256", name: "newYesPool", indexed: false },
      { type: "uint256", name: "newNoPool", indexed: false },
    ],
    anonymous: false,
  },
  {
    ...
    inputs: [
      ...
      { type: "address", name: "trader", indexed: true },
      { type: "bool", name: "side", indexed: false },
      { type: "uint256", name: "sharesIn", indexed: false },
      { type: "uint256", name: "plsOut", indexed: false },
