...
const PAIR_ENDPOINTS: Array<{ key: keyof PriceData; url: string; extra?: string[] }> = [
  ...
  { key: "ebtc", url: "https://api.dexscreener.com/latest/dex/pairs/pulsechain/0xFf1eFdf60A84268cB5CDB310f05ff47b242EBc20" },
...
async function fetchAllPrices(): Promise<PriceData> {
  const result: PriceData = {
    ...
    missor: 0, finvesta: 0, wgpp: 0, weth: 0, pwbtc: 0, ebtc: 0,
